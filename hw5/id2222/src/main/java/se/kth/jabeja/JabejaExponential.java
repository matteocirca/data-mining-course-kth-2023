...
public class JabejaExponential {
  final static Logger logger = Logger.getLogger(JabejaExponential.class);
  ...
  //-------------------------------------------------------------------
  public JabejaExponential(HashMap<Integer, Node> graph, Config config) {
  ...
  //-------------------------------------------------------------------
  public void startJabejaExponential() throws IOException {
  ...
  private void sampleAndSwap(int nodeId) {
    ...
    if (config.getNodeSelectionPolicy() == NodeSelectionPolicy.HYBRID
      ...
      // TODO
      Integer[] nodes = getNeighbors(nodep);
      partner = findPartner(nodeId, nodes);
    }
    ...
    if (config.getNodeSelectionPolicy() == NodeSelectionPolicy.HYBRID
      ...
      // TODO
      if (partner == null) {
        Integer[] nodes = getSample(nodeId);
        partner = findPartner(nodeId, nodes);
      }
    }
